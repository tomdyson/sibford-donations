"""
Django settings for sibford_donations project.
...
SECRET_KEY = "django-insecure-tk_eyo!^+6ue2(*8xd1tik3fh=-uxwtyhk8+8-g8t(o0==e5#u"
...
CSRF_TRUSTED_ORIGINS = os.environ.get(
    "CSRF_TRUSTED_ORIGINS", "http://localhost,http://127.0.0.1,https://cats.co.tomd.org"
).split(",")
...
ROOT_URLCONF = "sibford_donations.urls"
...
WSGI_APPLICATION = "sibford_donations.wsgi.application"
...
BANK_DETAILS = {
    "account_name": "Mrs S E Bannister",
    "sort_code": "20-03-84",
    "account_number": "60145440",
}
